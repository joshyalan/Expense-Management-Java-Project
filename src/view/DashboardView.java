...
public class DashboardView extends JFrame {
    ...
    private JPanel createHomePanel() {
        ...
        cardsPanel.add(createWidgetCard("Total Balance", "$12,450.00", Theme.PRIMARY, "↗ +5.2%"));
        cardsPanel.add(createWidgetCard("Monthly Income", "$5,200.00", Theme.SUCCESS, ""));
        cardsPanel.add(createWidgetCard("Monthly Expenses", "$1,850.50", Theme.DANGER, ""));
        cardsPanel.add(createWidgetCard("Health Score", "85 / 100", Theme.WARNING, "Excellent"));
    ...
    private JPanel createWidgetCard(String title, String amount, Color accentColor, String badgeText) {
        ...
        lblAmount.setFont(Theme.fontHeading1());
